package ru.geekbrains.java2.lessons.lesson3_collections;
...
//        List<String> list1 = new Vector<>();
        List<String> list = new LinkedList<>(); //двусвязный список
        list.add("Junuary");
        list.add("February");
//        list.add(null);
        list.add("March");
        list.add("February");
//        list.add(null);
        list.add(3,"April"); //добавляет со сдвигом
        list.set(4,"May"); //заменяет
        list.addAll(Arrays.asList("June","July","May","April"));
        list.remove(0);
//        list.remove("May");//удаляет первое совпадение
